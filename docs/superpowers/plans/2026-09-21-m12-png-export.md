...
…and the actions, placed beside the other document-reading actions. Note `errorMessage` already exists in `src/persist/project-io.ts`; import it if it is not already in scope.
